{
  ...
  let
    ...
    rosWorkspaceLib = import nix-ros-workspace { inherit system; };
    ...
    buildROSWorkspace =
      pkgs.callPackage
        (nix-ros-workspace + "/packages/ros/build-ros-workspace")
        {
          # Tell it which ROS distro/packages to use
          rosPackages = rosPkgs;
        };
...
EOF
    ...
    rosWorkspace = buildROSWorkspace {
      name = "polyflow";
